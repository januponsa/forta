...
with open(r'c:\Users\userJ\Documents\fortain\app\Livewire\Admin\EmailBlastManager.php', 'r', encoding='utf-8') as f:
    content = f.read()

new_logic = """    public function selectAllFiltered()
    {
...
content = content.replace("    public function render()", new_logic + "\n    public function render()")

with open(r'c:\Users\userJ\Documents\fortain\app\Livewire\Admin\EmailBlastManager.php', 'w', encoding='utf-8') as f:
    f.write(content)
print('Updated Manager logic')
